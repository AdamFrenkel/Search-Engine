public class PublicAPI{
     ...
     */
    public CourseOffering searchClassOffering(int ID,int ClassNumber,int Year, Semester semester String professorName ){
    }
   ...
   // public Set<Course> searchClassPrerequisites(int ID,int classNumber){}
     ...
     */
    public boolean addCoursesStudentHasTaken(int employeeID,int studentID,Set<Course>){}
     ...
     */
    public double giveGrade(int employeeID,int studentID,CoureOffering courseOffering, double grade){}
